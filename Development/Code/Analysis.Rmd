...
for (i in 1:m){
  ...
  lp.calibrated <- as.numeric(t(coef.calibrated.model.i) %*% t(predict.df))
  coef.calibrated.model <- c(coef.calibrated.model, coef.calibrated.model.i)
}
...
plot(plogis(shrinkage.factor.hypop*predict(final.model, type="lp")), 
     plogis(shrinkage.factor.hypop*lp.calibrated),
     xlab="Probability of Hypoparathyroidism", xlim=c(0, 1),
     ylab="Probability of Readmission", ylim=c(0, 1),
     main="Both shrunk with hypoP factor")
abline(0, 1)
