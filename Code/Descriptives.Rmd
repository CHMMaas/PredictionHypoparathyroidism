...
load("Z:/Project Predict Hypoparathyroidism/Data/data.to.be.imputed.Rdata")
...
work.data$dCorrCa24u <- ((work.data$CorrCaBaseline - work.data$CorrCa24u)/work.data$CorrCaBaseline*100)
work.data$dCa24u <- ((work.data$BaseCa - work.data$Ca24u)/work.data$BaseCa*100)
...
my_labels <- list(HypoP = "Hypoparathyroidism",
  ...
  dCorrCa24u = "Delta CorrCa", #(CorrCa at baseline - CorrCa at 24 hrs)/(CorrCa at baseline)*100
  dCa24u = "Delta Calcium", # (Baseline Calcium - Calcium at 24 hrs)/(Baseline Calcium)*100
